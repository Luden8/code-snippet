export default {
  rtable: {
    ...
    error: {
      ...
      checkProp:
        'The checkbox may stall when the amount of data is too large, it is recommended to set the parameter "{0}" to increase the rendering speed ',
      ...
      errFormat:
        'The global formatted content should be defined with "RTable.formats". Mounting "formatter={0}" is not recommended.',
    ...
    export: {
      ...
      expOpts: 'Settings',
      expOptHeader: 'Header',
      expheaderColumnTitle: 'Do I need a header',
      expOptFooter: 'Footer',
