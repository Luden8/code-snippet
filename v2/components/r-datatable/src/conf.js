const iconPrefix = 'r4m-table-icon-'

export default {
  size: null, // Global dimensions
  zIndex: 999, //  zIndex The starting value, if the z-index style value of the project is too large, you need to follow the setting to be larger to avoid being occluded
  version: 0, // Version number，Useful for some features with data caching, the up-to-date version number can be used to reset the data
  // resizeInterval: 500,
  emptyCell: '　',
  // loadingText: null, //Customize the loading prompt content, if it is null, the text will not be displayed
  table: {
    fit: true,
    showHeader: true,
    animat: true,
    ...
    // },
    // rowConfig: {
    //   keyField: '_X_ROW_KEY' // The name of the unique key field of the row data
    // },
    resizeConfig: {
      refreshDelay: 250
    },
    ...
    treeConfig: {
      ...
      childrenAccessField: 'children',
      hasChildField: 'hasChild',
      mapchildrenAccessField: '_X_ROW_CHILD',
      indent: 20,
      showIcon: true
    },
    expandConfig: {
  ...
  icon: {
    // loading
    LOADING: iconPrefix + 'spinner roll r4m-table-loading--default-icon',
    ...
    TABLE_TREE_READY: iconPrefix + 'spinner roll',
    TABLE_TREE_OPEN: iconPrefix + 'caret-right rotate90',
    TABLE_TREE_CLOSE: iconPrefix + 'caret-right',
    TABLE_EXPAND_LOADED: iconPrefix + 'spinner roll',
    TABLE_EXPAND_OPEN: iconPrefix + 'arrow-right rotate90',
    TABLE_EXPAND_CLOSE: iconPrefix + 'arrow-right',
    TABLE_CHECKBOX_selected: iconPrefix + 'checkbox-selected',
    TABLE_CHECKBOX_UNselected: iconPrefix + 'checkbox-unselected',
    TABLE_CHECKBOX_INDETERMINATE: iconPrefix + 'checkbox-indeterminate',
    TABLE_RADIO_selected: iconPrefix + 'radio-selected',
    TABLE_RADIO_UNselected: iconPrefix + 'radio-unselected',
